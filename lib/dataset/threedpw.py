...
class ThreeDPW_eval3dpw(Dataset3D_ThreeDPW):
    def __init__(self, set, seqlen, overlap=0.75, debug=False):
        ...
        super(ThreeDPW_eval3dpw, self).__init__(
            set=set,
            folder=THREEDPW_DIR,
            seqlen=seqlen,
            overlap=overlap,
...
class ThreeDPW_evalh36m(Dataset3D_H36M):
    def __init__(self, set, seqlen, overlap=0.75, debug=False):
        db_name = '3dpw'
        ...
        overlap = overlap if is_train else 0.
        print('3DPW Dataset overlap ratio: ', overlap)
        super(ThreeDPW_evalh36m, self).__init__(
            set=set,
            folder=THREEDPW_DIR,
            seqlen=seqlen,
            overlap=overlap,
